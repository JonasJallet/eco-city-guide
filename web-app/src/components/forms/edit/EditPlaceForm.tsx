...
function EditPlaceForm({ place, setIsEditionPanelAdmin, refetch }: Props) {
  ...
  const [updatePlaceMutation, { error }] =
  ...
  return (
    <div className="w-80 flex flex-col animate-fade items-center z-10 overflow-y-auto">
      <button
