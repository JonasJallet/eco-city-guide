  ...
  return (
    <>
      {!loading && data?.myProfile ? (
        <button
          onClick={toggleModal}
          className="p-3 mt-5 ml-4 mr-28 bg-tertiary_color rounded-full text-fontSizeModale shadow-lg shadow-secondary_color text-primary_color tracking-wide font-semibold font-sans"
        >
