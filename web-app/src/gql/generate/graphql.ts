...
export type PlacesQuery = { __typename?: 'Query', places: Array<{ __typename?: 'Place', id: string, name: string, coordinates: any, address: string, description: string, city: { __typename?: 'City', name: string }, categories: Array<{ __typename?: 'Category', name: string }> }> };
