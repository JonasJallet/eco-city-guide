...
export type GetMyProfileQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, hashedPassword: string, favoritesPlaces: Array<{ __typename?: 'Place', id: string, name: string, address: string, coordinates: any, createdAt: any, description: string, city: { __typename?: 'City', id: string, name: string, coordinates: any }, categories: Array<{ __typename?: 'Category', id: string, name: string, icon: string }>, owner?: { __typename?: 'User', id: string, createdAt: any, firstName: string, lastName: string, userInitials: string, role: string, email: string, hashedPassword: string, favoritesPlaces: Array<{ __typename?: 'Place', id: string, name: string }> } | null }> } };
