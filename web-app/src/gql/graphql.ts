...
export type GetMyProfileQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, hashedPassword: string } };
