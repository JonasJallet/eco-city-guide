...
export type GetMyProfileQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, hashedPassword: string, favoritesPlaces: Array<{ __typename?: 'Place', id: string, name: string, description: string, city: { __typename?: 'City', name: string } }> } };
